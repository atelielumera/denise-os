...
old_bloco = """          return(<div key={tema} style={{marginBottom:18}}>
...
new_bloco = """          return(<div key={tema} style={{marginBottom:22}}>
...
s = replace_once(s, old_bloco, new_bloco, "rotina-quadros")

main_file.write_text(s)
print("OK - Minha Rotina agora mostra cada item como um quadro (igual ao estilo dos cards do Home),")
print("agrupados por tema em grade, em vez de lista de linhas finas. Marcar feito, editar e excluir")
print("continuam funcionando igual.")
