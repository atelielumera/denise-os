...
# 1) Sugestoes volta a ser lista de linhas com "chevron" + dois botoes, igual a referencia real
#    (na imagem, essa secao especificamente NAO e grade — so Atencao/Padroes/Progresso sao)
old1 = """  function CardSugestaoLuna({ins}:{ins:LunaInsight}){
...
new1 = """  function LinhaSugestaoLuna({ins}:{ins:LunaInsight}){
...
s = replace_once(s, old1, new1, "sugestao-volta-lista")

# 2) Layout da secao: Sugestoes usa coluna (lista), as outras 3 usam grade
old2 = """    return(<div style={{marginBottom:26}}>
...
new2 = """    const layout=tipo==='sugestao'?'lista':'grade'
...
s = replace_once(s, old2, new2, "sugestao-layout-lista")
