...
api_dir = Path("api")
api_file = api_dir / "chat.js"
if api_file.exists():
    raise SystemExit("ABORTADO (api-file-exists): api/chat.js ja existe. Nada foi alterado.")

api_dir.mkdir(exist_ok=True)
api_content = """export default async function handler(req, res) {
  if (req.method !== 'POST') {
...
applied.append("create-api-chat")
